...
export default function Home() {
  return (
    <main className="min-h-screen">
      {/* ===== HERO SECTION ===== */}
      <section className="px-6 md:px-12 lg:px-24 pt-20 pb-16 max-w-5xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          <a
            ...
            className="text-tron-text-muted hover:text-tron-cyan transition-colors duration-200"
      ...
      {/* ===== FOOTER ===== */}
      <footer className="px-6 md:px-12 lg:px-24 py-12 max-w-5xl mx-auto">
